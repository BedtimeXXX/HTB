...
HULK_REPO="https://github.com/BedtimeXXX/HTB/hulk.git"
pullme_REPO="https://github.com/BedtimeXXX/HTB/submod.git"

# Final Exploit Repo
SMASH_REPO="https://github.com/BedtimeXXX/HTB/smash.git"
